                                ...
                                <div class="card-block">
                                    <form method="post" action="{{ route('inquiries.store') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label" for="licence_no">Licence
                                                        No:</label>
                                                    <div class="col-sm-9 input-group">
                                                        <input type="text" class="form-control m-0" id="licence_no"
                                                            name="licence_no">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group row">
                                                    <label class="col-sm-4 col-form-label" for="tel_digicel">TEL
                                                        Digicel:</label>
                                                    <div class="col-sm-8">
                                                        <input class="form-control m-0" id="tel_digicel"
