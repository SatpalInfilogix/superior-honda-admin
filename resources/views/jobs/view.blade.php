                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control m-0" id="name" name="name"
                                                        value="{{ $job->name }}" type="text" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="date" name="date" class="form-control m-0"
                                                        value="{{ $job->date }}" id="datepicker" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control m-0" id="mileage" name="mileage"
                                                        value="{{ $job->mileage }}" type="text" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control m-0" id="vehicle" name="vehicle"
                                                        value="{{ $job->vehicle }}" type="text" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control m-0" id="licence_no" name="licence_no"
                                                        value="{{ $job->licence_no }}" type="text" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control m-0" id="address" name="address"
                                                        value="{{ $job->address }}" type="text" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control m-0" id="returning" name="returning"
                                                        value="{{ $job->returning }}" type="text" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control m-0" id="color" name="color"
                                                        value="{{ $job->color }}" type="text" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control m-0" id="tel_digicel" name="tel_digicel"
                                                        value="{{ $job->tel_digicel }}" type="text" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control m-0" id="email" name="email"
                                                        value="{{ $job->email }}" type="email" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control m-0" id="tel_lime" name="tel_lime"
                                                        value="{{ $job->tel_lime }}" type="text" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="date" class="form-control m-0" id="date"
                                                        value="{{ $job->dob }}" name="dob" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control m-0" id="chassis" name="chassis"
                                                        value="{{ $job->chassis }}" type="text" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control m-0" id="engine" name="engine"
                                                        value="{{ $job->engine }}" type="text" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <textarea class="form-control m-0" id="notes" name="notes" rows="2" cols="200" readonly>{{ $job->notes }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        @if($job->conditions)
                                            @foreach (json_decode($job->conditions) as $key => $product)
                                                <div class="col-md-3">
