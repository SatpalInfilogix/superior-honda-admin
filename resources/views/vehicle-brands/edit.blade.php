<div class="modal fade" id="edit-vehicle-brand" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('vehicle-brands.store') }}" name="edit-vehicle-brand" method="POST">
                @csrf
...
<script>
    $(function() {
        $('[name="edit-vehicle-brand"]').validate({
            rules: {
